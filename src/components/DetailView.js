        ...
        return (
            <View>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View>
                    <Button color={'white'} style={{backgroundColor: '#c64c38'}} icon="arrow-left" mode="text" onPress={() => noneSelected()}>
                        Back
                    </Button> 
                    </View>
                    <View>
                    ...
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#ffffff'} style={{backgroundColor: '#941a1d'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#ffffff'} style={{backgroundColor: '#941a1d'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                                E-mail
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#ffffff'} style={{backgroundColor: '#941a1d'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
